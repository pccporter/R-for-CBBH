...
|:------------|:------------------------------------------------|
| *Monday*    |                                                 |
| 10.00-13.00 | Installation of R and RStudio                   |
|             | *Break*                                         |     
| 14.00-17.15 | Introduction to R and Rstudio (A+B)             |
| *Tuesday*   |                                                 |
| 09.00-13.00 | Data manipulation (C)                           |
|             | *Break*                                         |             
| 14.00-16.30 | Analyzing data (D)                              |
| *Wednesday* |                                                 |
| 09.00-13.00 | Data visualization  (E)                         |
|             | *Break*                                         |
| 14.00-16.30 | Loops and functions (F)                         |
| *Thursday*  |                                                 |
...
- Part D: Analyzing data 
    ...
    - [Lecture D - GSS version](Contents/Material/Part D - Analyzing data/Lecture_D_GSS.html)
    - [Practical D - GSS version](Contents/Material/Part D - Analyzing data/Practical_D_GSS.html)
    - [Practical D with solutions - GSS version](Contents/Material/Part D - Analyzing data/Practical_D_GSS_walkthrough.html)
...
Data and code for read and write examples:
