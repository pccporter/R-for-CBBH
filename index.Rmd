---
title: "Statistical Programming with R -test"
output: 
...
|:------------|:------------------------------------------------|
| *Monday*    |                                                 |
| 13.00-16.00 | Introduction to R and Rstudio (A+B)             |
| *Tuesday*   |                                                 |
| 09.00-12.00 | Data manipulation (C)                           |
|             | *Break*                                         |             
| 13.00-16.00 | Analyzing data (D)                              |
| *Wednesday* |                                                 |
| 09.00-12.00 | Data visualization  (E)                         |
|             | *Break*                                         |
| 13.00-16.00 | Loops and functions (F)                         |
| *Thursday*  |                                                 |
...
- Part D: Analyzing data 
    - [XXXXLecture D](Contents/Material/Part D - Analyzing data/Lecture_D.html)
    - [XXXXPractical D](Contents/Material/Part D - Analyzing data/Practical_D.html)
    - [XXXXPractical D with solutions](Contents/Material/Part D - Analyzing data/Practical_D_walkthrough.html)
