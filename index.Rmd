...
3.  Basic to advanced programming skills: Loops and functions, 
4.  Data manipulation and basic statistics 
...
| *Tuesday*   |                                                 |
| 09.00-12.00 | Data in R, reading in and exporting data (C)    |
|             | *Break*                                         |             
| 13.00-16.00 | Loops and functions (E)                         |
| *Wednesday* |                                                 |
| 09.00-12.00 | Data manipulation (F)                           |
|             | *Break*                                         |
| 13.00-16.00 | Data visualisation (I)                          |
| *Thursday*  |                                                 |
...
- Part A: Introduction
    ...
    - [Lecture A Handout](Contents/Material/Part A - Introduction/Lecture_A_handout.html){target="_blank"}
...
- Part B: How is `R` organized?
    ...
    - [Lecture B Handout](Contents/Material/Part B - How is R organized/Lecture_B_handout.html){target="_blank"}
    - [Practical B](Contents/Material/Part B - How is R organized/Practical_B_walkthrough.html){target="_blank"}
    - [Impractical B](Contents/Material/Part B - How is R organized/Practical_B.html){target="_blank"}
...
- Part C: `R` Functionality and reading in data
    - [Lecture C](Contents/Material/Part C - R-functionality/Lecture_C.html){target="_blank"}
    - [Lecture C Handout](Contents/Material/Part C - R-functionality/Lecture_C_handout.html){target="_blank"}
    - [Practical C](Contents/Material/Part C - R-functionality/Practical_C.html){target="_blank"}
    - [Practical C with solutions](Contents/Material/Part C - R-functionality/Practical_C_walkthrough.html){target="_blank"}
...
- Part F: Data manipulation and basic statstiscs
    - [Lecture F](Contents/Material/Part F - Pipes/Lecture_F.html){target="_blank"}
    - [Lecture F Handout](Contents/Material/Part F - Pipes/Lecture_F_Handout.html){target="_blank"}
- Part I: Data visualization
    - [Lecture I](Contents/Material/Part I - Data visualization/Lecture_i.html){target="_blank"}
    - [Practical I](Contents/Material/Part I - Data visualization/Practical_i_walkthrough.html){target="_blank"}
    - [Practical I - using ggplot](Contents/Material/Part I - Data visualization/Practical_i_walkthrough_ggplot.html){target="_blank"}
    - [Impractical I](Contents/Material/Part I - Data visualization/Practical_i.html){target="_blank"}
