...
- Extends the functionality of R
  ...
  - Introduce more convenient methods for datamanipulation
  - ... And much more
...
<center>
<img src="figures/fig5.png" alt="HTML5 Icon" width = 100%>
</center>
...
```
- This i called a relative and an absolute path.
...
# SAS
boys_dta <- haven::read_dta("boys.dta")
```
...
con <- dbConnect(drv = RSQLite::SQLite(),
                 dbname = "boys_database.sqlite")
con
```

```{r echo = FALSE}
cat("<SQLiteConnection>
  Path: C:\\Users\\Morten\\boys_database.sqlite
  Extensions: TRUE")
```
